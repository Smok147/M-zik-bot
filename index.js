...
.addField(`Servant Music - Teşekkürler`, `Selamlar, ben Smok(Servant Music Geliştiricisi) öncelikle botumuzu eklediğiniz ve bana destek olduğunuz için sizlere teşekkürl
erimi sunarım`)
...
client.user.setActivity(`Servant Music | +yardım | created by Samet#4569        | ` + client.guilds.cache.size + ` Sunucu | ` + client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ` Kullanıcı`, { type: 'LISTENING' });
});
